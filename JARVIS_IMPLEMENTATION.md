...
Open **http://127.0.0.1:8765**. The website requires the configured Hermes and NVIDIA services; there is no demo runtime or simulated response path. On Windows, activate with `.venv\Scripts\activate`.
